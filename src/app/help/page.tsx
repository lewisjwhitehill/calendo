  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      ...
      <p className="text-lg text-gray-700">
        <strong>Tips:</strong> Be specific with times and dates. If something doesn&rsquo;t look right, feel free to delete or edit the event directly in Google Calendar. Always double-check event details after creation.
      </p>
    </div>
  );
}
